...
class Trader:
    ...
    Product.VOLCANIC_ROCK_VOUCHER_10500,
        ...
        if "open_spread_trade" in traderObject:
            open_trade = traderObject["open_spread_trade"]
            over = open_trade["over"]
            under = open_trade["under"]
            ...
            # If both sides are near fair value → close the spread
            if abs(diff_over) < exit_threshold and abs(diff_under) < exit_threshold:
                # Close both legs: reverse position
                ...
                if over_pos != 0:
                    ...
                    result[over] = [Order(over, best_price, -over_pos)]
                ...
                if under_pos != 0:
                    ...
                    result[under] = [Order(under, best_price, -under_pos)]


                # Clear the open trade record
                traderObject.pop("open_spread_trade")
